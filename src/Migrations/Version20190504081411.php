 ...
 */
final class Version20190504081411 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE dialog_messages ADD is_operator TINYINT(1) NOT NULL, DROP client_id, DROP operator_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE dialog_messages ADD client_id INT DEFAULT NULL, ADD operator_id INT DEFAULT NULL, DROP is_operator');
