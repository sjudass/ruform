 ...
 */
final class Version20190602165018 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE applications DROP FOREIGN KEY FK_F7C966F019EB6921');
        $this->addSql('ALTER TABLE applications ADD CONSTRAINT FK_F7C966F019EB6921 FOREIGN KEY (client_id) REFERENCES client (id)');
    }
}
